            ...
            <div className='sidebar'>
                ...
                <div className='facet'>
                    ...
                    <div className='Prices ratings'>
                        <Collapse
                            activeKey={[`${showCollapsePrice === true ? contaiPrice : ''}`]}
                            onChange={onChangePrice}
                            accordion
                        >
                            <Panel className='categories-content-box-none' header='<=100.00' key={1}></Panel>
                            ...
                            <Panel header='>1000.00' className='categories-content-box-none' key={5}></Panel>
